    ...
    <div class="container-fluid h-100">
        <div class="row h-100">
            ...
            <div class="col py-4">
                ...
                <div class="row mb-4">
<?php
    $sql = "select id, Name, StartTime, Duration, DayOfWeek from Courses as c where c.InstructorId=$id;";
...
?>
                    <div class="mt-3 col-12 col-md-6 col-lg-4">
                        <div class="card">
                            ...
                            <a href="/sods/courses/resign.php?course=<?php echo $courseId?>" class="btn btn-danger">Resign</a>
                        </div>
                    </div>
<?php            
        }
...
?>
                ...
                <div class="row mb-4">
<?php
    $sql = "select id, Name, StartTime, Duration, DayOfWeek from Courses as c where c.InstructorId is NULL;";
    $result = mysqli_query($link, $sql);
...
?>
                    <div class="mt-3 col-12 col-md-6 col-lg-4">
                        <div class="card">
                            ...
                            <a href="/sods/courses/apply.php?course=<?php echo $courseId?>" class="btn btn-primary">Apply</a>
                        </div>
                    </div>
<?php            
        }
